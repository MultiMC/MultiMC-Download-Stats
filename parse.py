...
print 'Unique Windows, OS X, Linux: {0} {1} {2}'.format(unique_windows,
                                                        unique_osx,
                                                        unique_linux)
print 'Unique %: {0} {1} {2}'.format(percentage(unique_windows, uniques_count),
                                     percentage(unique_osx, uniques_count),
                                     percentage(unique_linux, uniques_count))
